            ...
            $.ajax({
                ...
                success:function(rs) {
                    ...
                    $(rs).each(function(index,item){
                        //2020-7-6
                        //前端处理date的时间显示
                        // var dateInfo1=new Date(item.addtime);
                        // var addtime=dateInfo1.getFullYear()+"-"+(dateInfo1.getMonth()+1)+"-"+dateInfo1.getDate();
                        // var dateInfo2=new Date(item.updatetime);
                        // var updatetime=dateInfo2.getFullYear()+"-"+(dateInfo2.getMonth()+1)+"-"+dateInfo2.getDate();
                        var tr="\n"+
