        ...
        $(function () {
            $.ajax({
                ...
                success: function (rs) {
                    ...
                    $("#companyperson").text(rs.companyperson);
                    $("#comaddress").text(rs.comaddress);
                    $("#comphone").text(rs.comphone);
                    $("#camera").text(rs.camera);
                    $("#present").text(rs.present);
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" id="cname"></td>
</tr>
<tr >
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><p id="present"></p></td>
</tr>
