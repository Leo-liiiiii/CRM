...
<table  width='99%' height="100%" border='0' cellspacing='0' cellpadding='0' >
	<tr>
		<td style='padding-left:3px;padding-top:8px' valign='top' id="menuss">
			...
			<%--分角色显示列表的代码--%>
			<%--<dl class='bitem'>--%>
				<%--<c:forEach items="${sessionScope.userMenu}" var="sources" varStatus="index">--%>
					<%--<dt onclick=showHide("items${index.count}_1")><b>${sources.name}</b></dt>--%>
					<%--<dd style='display:none' class='sitem' id=items${index.count}_1>--%>
						<%--<ul class='sitemu' id=${index.count-1}>--%>
							<%--<c:forEach items="${sources.children}" var="child">--%>
