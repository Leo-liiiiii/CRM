...
<title>用户管理</title>
    ...
    <script type="application/javascript">
        $(function () {
            $.ajax({
                type:'GET',
                url:'${pageContext.request.contextPath}/emp/showAllemp',
                dataType:'json',
                success:function (rs) {
              ...
              //前端处理date的时间显示
              var dateInfo=new Date(item.hiredate);
              var hiredate=dateInfo.getFullYear()+"-"+(dateInfo.getMonth()+1)+"-"+dateInfo.getDate();
...
<tr align="center" bgcolor="#FAFAF1" height="22"  id="tr">
	<td width="4%">选择</td>
	<td width="6%">序号</td>
	<td width="10%">姓名</td>
	<td width="10%">职位</td>
