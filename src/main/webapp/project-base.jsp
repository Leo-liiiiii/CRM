              ...
              $.ajax({
                  ...
                  success:function(rs){
                      $(rs).each(function(index,item){
                          //2020-7-6
                          //前端处理date的时间显示
                          var dateInfo1=new Date(item.starttime);
                          var startime=dateInfo1.getFullYear()+"-"+(dateInfo1.getMonth()+1)+"-"+dateInfo1.getDate();
                          var dateInfo2=new Date(item.buildtime);
                          var buildtime=dateInfo2.getFullYear()+"-"+(dateInfo2.getMonth()+1)+"-"+dateInfo2.getDate();
                          var dateInfo3=new Date(item.endtime);
                          var endtime=dateInfo3.getFullYear()+"-"+(dateInfo3.getMonth()+1)+"-"+dateInfo3.getDate();
